...
_LAZY_ATTRS: dict[str, tuple[str, str]] = {
    ...
    "FactorScreenerBatch": ("tiger_factors.factor_screener", "FactorScreenerBatch"),
    "FactorScreenerBatchItem": ("tiger_factors.factor_screener", "FactorScreenerBatchItem"),
    "FactorScreenerBatchResult": ("tiger_factors.factor_screener", "FactorScreenerBatchResult"),
    "FactorScreenerBatchSpec": ("tiger_factors.factor_screener", "FactorScreenerBatchSpec"),
    "FactorScreenerDetailManifest": ("tiger_factors.factor_screener", "FactorScreenerDetailManifest"),
    "FactorReturnGainSelectionConfig": ("tiger_factors.factor_screener", "FactorReturnGainSelectionConfig"),
    "FactorSelectionMode": ("tiger_factors.factor_screener", "FactorSelectionMode"),
    "FactorMarginalSelectionConfig": ("tiger_factors.factor_screener", "FactorMarginalSelectionConfig"),
