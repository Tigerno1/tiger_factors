"""Shared reporting helpers for BM / F-score value-quality demos."""
...
def save_value_quality_backtest_plot(
    backtest: pd.DataFrame,
    *,
    output_dir: str | Path,
    report_name: str = "value_quality_long_short",
) -> Path | None:
    """Save a standard cumulative-return plus drawdown report for the strategy."""
    ...
    axes[0].set_title("Value / Quality Long-Short Equity Curve")
...
__all__ = ["save_value_quality_backtest_plot"]
